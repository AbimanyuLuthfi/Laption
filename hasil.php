									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_laptop=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_laptop['harga_angka'],$data_laptop['ram_angka'],$data_laptop['storage_angka'],$data_laptop['processor_angka'],$data_laptop['baterai_angka'] );
												?>
												<tr>
													...
													<td><center><?php echo $data_laptop['storage_angka'] ?></center></td>
													<td><center><?php echo $data_laptop['processor_angka'] ?></center></td>
													<td><center><?php echo $data_laptop['baterai_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
										...
										<tbody>
											...
											while ($data_hp=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_hp['harga_angka']/$pembagiNM[0],
													...
													$data_hp['storage_angka']/$pembagiNM[2],
													$data_hp['processor_angka']/$pembagiNM[3],
													$data_hp['baterai_angka']/$pembagiNM[4]);
													...
													<tr>
														...
														<td><center><?php echo round($data_hp['storage_angka']/$pembagiNM[2],6) ?></center></td>
														<td><center><?php echo round($data_hp['processor_angka']/$pembagiNM[3],6) ?></center></td>
														<td><center><?php echo round($data_hp['baterai_angka']/$pembagiNM[4],6) ?></center></td>
													</tr>
													<?php
													$no++;
												}
										...
										<table class="responsive-table">
											<thead>
												<tr>
													...
													<th><center>Value Kriteria Storage</center></th>
												...
												<tbody>
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																$query=mysqli_query($selectdb,"SELECT * FROM data_laptop where id = $i+1");
																?>
